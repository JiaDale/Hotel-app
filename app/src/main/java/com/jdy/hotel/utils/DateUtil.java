...
public class DateUtil {
    ...
    public static String dateFormat(String target, String format) {
        ...
        if (StringUtil.hasNoNumber(target)) {
            String temp = target;
            target = format;
            format = temp;
        }
    ...
    private static DateFormat getDateFormat(String format) {
        if (StringUtil.isBlack(format)) {
            return null;
        }

        if (StringUtil.hasNumber(format)) {
    ...
    private static boolean isDateFormat(String separator, String format) {
        ...
        if (StringUtil.hasChinese(separator)) {
            numberRegex += "_";
            formatRegex += "_";
        }
        ...
        if (StringUtil.isNotEmpty(timeFormat)) {
            ...
            if (StringUtil.hasChinese(tempSeparators)) {
                numberRegex += "_";
                formatRegex += "_";
            }
