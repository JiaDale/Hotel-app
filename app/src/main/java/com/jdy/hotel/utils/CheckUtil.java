...
public class CheckUtil {
    ...
    public static <T, R> R checkValue(T value, R defaultValue, Function<T, R> function) {
        return checkValue(value, ObjectUtils.isNull(value), defaultValue, function);
    }
    ...
    public static <T> T checkValue(T value, T defaultValue) {
        return checkValue(value, ObjectUtils.isNull(value), defaultValue);
    }
    ...
    static <T> Predicate<T> rePredicate(Predicate<T> predicate) {
        if (null == predicate) {
            return ObjectUtils::isNull;
        }
        Predicate<T> temp = ObjectUtils::isNull;
