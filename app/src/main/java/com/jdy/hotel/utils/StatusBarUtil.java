...
import com.jdy.hotel.support.SystemBarTintManager;
...
//            window.setStatusBarColor(Color.TRANSPARENT);//设置状态栏颜色透明
    ...
    public static void setTranslucentStatus(Activity activity, boolean add) {
        ViewGroup contentFrameLayout = (ViewGroup) activity.findViewById(android.R.id.content);
        View parentView = contentFrameLayout.getChildAt(0);
        if (parentView == null || !add) return;
        //布局预留状态栏高度的 padding
    ...
    public static void setRootViewFitsSystemWindows(Activity activity, boolean fitSystemWindows) {
        ...
        if (null == winContent || winContent.getChildCount() < 1) {
            return;
        }
    ...
    public static int getStatusBarHeight(Context context) {
        if (context == null) {
            L.e("Please provide the object that needs to set Context!");
            return 0;
        }
